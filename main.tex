...
Ova metoda određuje klase koristeći linarnu funkciju $w^{T}x + b$. SVM predviđa prvu klasu ako je izlaz funkcije je pozitivan, a predviđa drugu klasu je izlaz negativan.
