...
Pretpostavimo da imamo metodu za treniranje koja vraca norme $|x_j|$, labele $y_j$ 
...
Kernel matrica je od velike vaznosti za least-squares reformulaciju algoritma. 
