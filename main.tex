...
\[
    \Ket{\psi}\Ket{0} \to \sum_i \psi_i\Ket{\chi_i}\Ket{\widetilde{r_i}}
\] 
Gde je $\Ket{\chi_i}$ eigen vektor od matrice $\rho$, $\widetilde{r_i}$ je esimacija eigen vrednosti, a $\psi_i = \Braket{\chi_i|\psi}$.
