...
Neka name je svaka unitarne transformacija oblika $e^{i\theta\sum}$, gde je $\sum$ produkt tenzora koji se sastoji iz skupa Paulijevih operatora, i rade nad nekolicinom kubita.
...
Ovaj rezultat kvantno reprezentacije ima analog u klasicnoj teoriji reprezentacije \cite{Cybenko1989ApproximationBS}.
