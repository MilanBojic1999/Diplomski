...
\subsubsection*{Kvantno uplitanje}
Kvantno uplitanje (engl. Quantum entanglement) je fizički pojam gde su dva, ili više, kubita povezana tako da zajedno prave novo kvantno stanje.
...
Kvantno računarstvo je vrsta računarstva gde se koriste kolekcije fizičkih osobina kvantne mehanike kao što su superpozicija i kvantno uplitanje,
...
mogu iskazati u klasičnoj informaciji, kao što su superpozicija i kvantno uplitanje \cite{Classical&quantum_info} \\
...
\subsubsection{Kvantni algoritam}
U kvantnom algoritmu bitno nam je da nađemo eigen vektore i eigen vrednosti za ulaz. Ovo se dosta oslanja na drugi deo metode koji je opisan u \textit{Quantum support vector machine} sekciji.
